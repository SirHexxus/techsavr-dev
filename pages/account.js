    ...
    <DashboardShell>
      ...
      >
        ...
        <SettingsTable stripeRole={user?.stripeRole}>
          <FeedbackUsage />
          <Text my={4}>
            TechSavr uses Stripe to update, change, or cancel your subscription.
            You can also update card information and billing addresses through
            the secure portal.
          </Text>
